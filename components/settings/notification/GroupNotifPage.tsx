...
export default function GroupNotifPage() {
  return (
    <div className="h-full overflow-y-auto p-4 space-y-4">
      <Section
        title="Private Groups"
        desc="Notifications for private group conversations"
      />

      <Toggle label="Mentions Only" />
      <Toggle label="Notify When Added to Group" />
      <Toggle label="Admin Messages Priority" />
      <Toggle label="Mute New Groups by Default" />
    </div>
  );
}
  ...
  return (
    <div className="flex justify-between items-center py-3">
      ...
      >
        ...
        {/* KNOB — PERFECT CENTER */}
        <motion.div
          className={`absolute top-1/2 left-[3px] w-4 h-4 rounded-full
