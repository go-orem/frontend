      ...
      >
        ...
        <polyline
          ...
          style={{
            ...
            animation: "draw 1.2s forwards ease-out",
          }}
        />
...
export function AreaChartSVG({
  ...
  const path = useMemo(
    () =>
      norm
        .map((v, i) => `${(i / (norm.length - 1)) * 100},${100 - v}`)
        .join(" ") + " 100,100 0,100",
    [norm]
  );
      ...
      >
        ...
        <polyline
          ...
          style={{
            ...
            animation: "draw 900ms forwards ease-out",
            filter: "url(#glow)",
          }}
        />
      </svg>
        ...
        {data.map((v, i) => {
          ...
          return (
            <rect
              ...
              fill="url(#barGrad)"
              style={{
                transformOrigin: `${x + w / 2}% 50%`,
                transform: "translateY(8px)",
                animation: `barUp 600ms ${i * 70}ms forwards ease-out`,
                filter: "url(#barGlow)",
              }}
            />
          );
      ...
      >
        ...
        <path
          ...
          style={{
            ...
            animation: "waveDraw 900ms forwards ease-out",
            filter: "url(#waveGlow)",
          }}
        />
      </svg>
        ...
        {(["line", "area", "bar", "donut", "wave"] as const).map((t) => (
          <button
            ...
            className={`text-xs px-3 py-1 rounded-full  ${
              tab === t
                ? "bg-[#30d5ff] text-black"
                : "bg-[#141418] text-gray-300"
            }`}
          >
            {t.toUpperCase()}
          </button>
