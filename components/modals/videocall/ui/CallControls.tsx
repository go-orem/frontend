  ...
  return (
    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-3 items-center z-99">
      ...
      <button
        ...
        className={`p-3 rounded-full bg-white/10 transition-transform ${
          switching ? "scale-95" : ""
        }`}
      >
        🔄
      ...
      <button
        ...
        className="p-3 rounded-full bg-white/10 flex items-center gap-1"
      >
        <Sparkles size={16} />
      </button>
      ...
      <button
        onClick={() =>
          applyVirtualBackground(
            "/mnt/data/Screenshot 2025-11-21 at 07.44.47.png"
          )
        }
        className="p-3 rounded-full bg-white/10"
      >
      ...
      <button
        onClick={endCall}
        className="p-3 rounded-full bg-red-600 text-white shadow-lg"
      >
        <PhoneOff />
      </button>
    </div>
